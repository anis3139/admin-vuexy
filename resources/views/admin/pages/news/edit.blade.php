            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="" action="{{ route('news.update', $news->id) }}" method="POST" enctype="multipart/form-data" files="true">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12 mb-1">
                                        <div class="form-group">
                                            ...
                                            <textarea placeholder="Enter Description" name="description" id="description" class="form-control">{{ $news->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-md-6 col-12 mb-1">
                                        <div class="form-group">
                                            <label for="descriptionEn">Description English</label>
                                            <textarea placeholder="Enter Description" name="descriptionEn" id="descriptionEn" class="form-control">{{ $news->descriptionEn }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-md-6 col-12 mb-1">
                                        <div class="form-group">
